...
- Detect already-installed packages and surface their versions in search results, dependency listings, and the package menu header, including an explicit `(installed)` badge in search choices.
